...
*/}}
{{- define "version-exporter.fullname" -}}
...
Common labels
*/}}
{{- define "version-exporter.labels" -}}
app.kubernetes.io/name: {{ include "version-exporter.name" . }}
helm.sh/chart: {{ include "version-exporter.chart" . }}
...
*/}}
{{- define "version-exporter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "version-exporter.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
