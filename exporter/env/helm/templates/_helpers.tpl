...
Common labels
*/}}
{{- define "env-exporter.labels" -}}
app.kubernetes.io/name: {{ include "env-exporter.name" . }}
helm.sh/chart: {{ include "env-exporter.chart" . }}
...
*/}}
{{- define "env-exporter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "env-exporter.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
