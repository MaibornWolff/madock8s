...
import (
	...
	github "github.com/MaibornWolff/maDocK8s/exporter/github/pkg"
...
func main() {
	...
	githubService := github.NewService(name, &storageProvider, adapter.GetMdFiles, log)
	Start(githubService, port)
}
