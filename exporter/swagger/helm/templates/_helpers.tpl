...
*/}}
{{- define "swagger-exporter.fullname" -}}
...
Common labels
*/}}
{{- define "swagger-exporter.labels" -}}
app.kubernetes.io/name: {{ include "swagger-exporter.name" . }}
helm.sh/chart: {{ include "swagger-exporter.chart" . }}
...
*/}}
{{- define "swagger-exporter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "swagger-exporter.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
