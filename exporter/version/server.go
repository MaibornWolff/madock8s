...
import (
	...
	versionExporter "github.com/MaibornWolff/maDocK8s/exporter/version/pkg"
...
func main() {
	...
	storageProvider := adapter.MdStorageProvider{
		Address: *storageAddress,
	}

	versionService := versionExporter.NewService(name, &storageProvider, adapter.GetVersions, log)
	Start(versionService, port)
}
